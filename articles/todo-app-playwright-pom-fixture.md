---
title: "PlaywrightでTodoアプリのE2Eテストを設計した話（Page Object Model・Fixture編）"
emoji: "🧪"
...
`data-testid` を振る方法も検討しましたが、今回はUIのアクセシビリティ属性（ロール・アクセシブルネーム）だけでテストが組めることを確認したかったので、あえてrole基準に統一しました。
...
最初はこの設定が抜けており、CI上でのみ接続エラーが発生しました。ローカルで通ったから大丈夫、とはいかないことを実感した箇所です。
